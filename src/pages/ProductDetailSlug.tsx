              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                 ...
                 {/* Installments */}
                  ...
                  <Button variant="outline" onClick={() => setIsPaymentModalOpen(true)} className="w-auto border border-gray-400 text-black hover:bg-gray-50 rounded-md font-normal text-sm flex items-center gap-2 mt-[0.6rem] py-[2.22px] px-[12px] mx-0 my-0">
